...
export default function Questionnaire() {
  ...
  const resumeMarkdown =
    sessionStorage.getItem("resumeMarkdown");
      ...
      <main className="flex min-h-screen items-center justify-center bg-[#f6f8fa] px-6">
        ...
        <div className="w-full max-w-md rounded-2xl border border-neutral-200 bg-white px-8 py-10 text-center shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-neutral-500">
            MergeMate is comparing your current skills
            with the requirements for your target role.
          </p>
      ...
      <Card>
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-500">
            This helps us find issues that match your
